						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("Point");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.Point === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<toMeasuringDocPlural> (" + iNumberOfItems + ")"}),
								success : function () {
